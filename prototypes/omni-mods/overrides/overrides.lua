...
omni.add_resource("raw-borax",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-borax.png","PyCoalTBaA-Temp-Dark")

omni.add_resource("niobium-ore",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-niobium.png","PyCoalTBaA-Temp-Dark")
...
if mods["pyfusionenergy"] then
	...
	omni.add_resource("molybdenum-ore",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-molybdenum-ore.png","PyCoalTBaA-Temp-Dark")

	omni.add_resource("regolite-rock",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-regolite-rock.png","PyCoalTBaA-Temp-Dark")

	omni.add_resource("kimberlite-rock",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-kimberlite-rock.png","PyCoalTBaA-Temp-Dark")
...
if mods["pyhightech"] then
	...
	omni.add_resource("phosphate-rock",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-phosphate-rock.png","PyCoalTBaA-Temp-Dark")

	omni.add_resource("rare-earth-ore",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-rare-earth-ore.png","PyCoalTBaA-Temp-Dark")
...
if mods["pyrawores"] then
	...
	omni.add_resource("ore-chromium",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-chromium.png","PyCoalTBaA-Temp-Dark")
	omni.add_resource("ore-aluminium",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-aluminium.png","PyCoalTBaA-Temp-Dark")
	omni.add_resource("ore-zinc",3,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-zinc.png","PyCoalTBaA-Temp-Dark")
	omni.add_resource("ore-tin",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-tin.png","PyCoalTBaA-Temp-Dark")
	omni.add_resource("raw-coal",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-coal.png","PyCoalTBaA-Temp-Dark")
	omni.add_resource("ore-quartz",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-quartz.png","PyCoalTBaA-Temp-Dark")
	omni.add_resource("ore-nickel",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-nickel.png","PyCoalTBaA-Temp-Dark")
	omni.add_resource("ore-lead",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-lead.png","PyCoalTBaA-Temp-Dark")
	omni.add_resource("salt",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-salt.png","PyCoalTBaA-Temp-Dark")

	if mods['boblibaray'] then

		omni.add_resource("ore-titanium",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-titanium.png","PyCoalTBaA-Temp-Dark")

	else

		omni.add_resource("ore-titanium",3,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-titanium.png","PyCoalTBaA-Temp-Dark")
