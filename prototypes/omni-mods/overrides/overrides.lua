...
omni.add_resource("raw-borax",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-borax.png","PyCoalTBaA")

omni.add_resource("niobium-ore",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-niobium.png","PyCoalTBaA")
...
if mods["pyfusionenergy"] then
	...
	omni.add_resource("molybdenum-ore",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-molybdenum-ore.png","PyCoalTBaA")

	omni.add_resource("regolite-rock",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-regolite-rock.png","PyCoalTBaA")

	omni.add_resource("kimberlite-rock",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-kimberlite-rock.png","PyCoalTBaA")
...
if mods["pyhightech"] then
	...
	omni.add_resource("phosphate-rock",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-phosphate-rock.png","PyCoalTBaA")

	omni.add_resource("rare-earth-ore",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-rare-earth-ore.png","PyCoalTBaA")
...
if mods["pyrawores"] then
	...
	omni.add_resource("ore-chromium",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-chromium.png","PyCoalTBaA")
	omni.add_resource("ore-aluminium",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-aluminium.png","PyCoalTBaA")
	omni.add_resource("ore-zinc",3,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-zinc.png","PyCoalTBaA")
	omni.add_resource("ore-tin",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-tin.png","PyCoalTBaA")
	omni.add_resource("raw-coal",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-coal.png","PyCoalTBaA")
	omni.add_resource("ore-quartz",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-quartz.png","PyCoalTBaA")
	omni.add_resource("ore-nickel",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-nickel.png","PyCoalTBaA")
	omni.add_resource("ore-lead",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-lead.png","PyCoalTBaA")
	omni.add_resource("salt",2,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-salt.png","PyCoalTBaA")

	if mods['boblibaray'] then

		omni.add_resource("ore-titanium",1,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-titanium.png","PyCoalTBaA")

	else

		omni.add_resource("ore-titanium",3,"__PyCoalTBaA-Temp-Dark__/graphics/technology/extraction-ore-titanium.png","PyCoalTBaA")
