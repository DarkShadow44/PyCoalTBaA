...
if mods['angelspetrochem'] then
    ...
    if mods['pyfusionenergy'] then
        ...
        table.insert(data.raw['technology']['slag-processing-1'].effects, {type = 'unlock-recipe', recipe = 'slag-processing-mol'})
        table.insert(data.raw['technology']['advanced-ore-refining-3'].effects, {type = 'unlock-recipe', recipe = 'angelsore-crystal-mix-mol-processing'})
    end
