...
if not mods['Bio_Industries'] or mods['boblibrary'] then
...
if mods['pyrawores'] then
    if mods['bobores'] then
        remove_ore('bauxite-ore')
        remove_ore('cobalt-ore')
        remove_ore('gem-ore')
        remove_ore('gold-ore')
        remove_ore('lead-ore')
        remove_ore('nickel-ore')
        remove_ore('quartz')
        remove_ore('rutile-ore')
        remove_ore('silver-ore')
        remove_ore('sulfur')
        remove_ore('tin-ore')
        remove_ore('tungsten-ore')
        remove_ore('zinc-ore')
